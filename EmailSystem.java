...
public class EmailSystem {
     ...
     private static final EmailServices emailServices = new EmailServicesImpl();
    ...
    private static void info() {
         display(userService.login(request));
    }
    ...
    private static void sendMail(){
         ...
         if (userService.findByEmail(recipientEMail) == null){
         ...
         display("sent");
         display(emailServices.sendMail(emailRequest));
         webPage();
    }

    private static void checkMail(){
         int id = Integer.parseInt(sout("enter mail id"));
         display(emailServices.checkMail((id)));
         webPage();
    }
    ...
    private static void deleteMail(){
         try {
             String subject = sout("enter mail subject");
             emailServices.deleteMail(subject);
    ...
    private static void mailSize(){
         display(String.valueOf(emailServices.mailSize()));
         webPage();
    }
